...
const LoginScreen = () => {
    ...
    const loginHandler = async () => {
        ...
        try {
            console.log(REACT_APP_API_IP);
            const response = await fetch(`http://${REACT_APP_API_IP}:3000/auth/login`, {
                method: 'POST',
                headers: {
    ...
    return (
        <KeyboardAvoidingView style={styles.container}>
            ...
            <View style={styles.buttonContainer}>
                ...
                <TouchableOpacity style={styles.signup} onPress={() => { navigator.navigate('Signup') }}>
